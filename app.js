...
var applePayController = (function (uiController) {
  var BACKEND_URL_VALIDATE_SESSION = 'https://aa65532e385e.ngrok.io/validateSession'
  var BACKEND_URL_PAY = 'https://aa65532e385e.ngrok.io/pay'

  // High level configuration options.
  var config = {
    payments: {
      acceptedCardSchemes: ['amex', 'masterCard', 'interac', 'visa']
    },
    shop: {
      product_price: 10.0,
      shop_name: 'dev',
